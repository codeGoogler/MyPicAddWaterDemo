package com.king.yyh.wk.activity.select2;
 ...
 * 正下方保存  文字
 */
public class PicMainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_picmain2);
        initViews();
    }
    ...
    private void initViews() {
        ...
        findViewById(R.id.btnPhoto).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(PicMainActivity2.this, SelectPicActivity.class);
        ...
        if (resultCode == Activity.RESULT_OK) {
            if (requestCode == this.requestCode) {
                ...
                try {
                    ...
                    Log.e("yyh","高度："+bm.getHeight()+" 宽度：" + bm.getWidth());
                    Log.e("yyh","高度："+imageView.getHeight()+" 宽度：" + imageView.getWidth());
                    if (bm == null) {
                        Toast.makeText(this, R.string.no_choosed_pic, Toast.LENGTH_SHORT).show();
                    }else{
